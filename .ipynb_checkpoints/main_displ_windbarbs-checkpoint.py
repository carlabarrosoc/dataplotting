...
import argparse
from Ejemplo_8 import plot_nwp  # Make sure this file and function exist
...
def main (date_nwp,extent):
    plot_nwp(model='ecmwf',
        ...
        var='winds',scale=1,offset=0,
        level_hpa='500',
        level_min=0,level_max=60,level_int=5,
        plot_type='barbs',contour_color='black',
